...
public class Tutor extends Teacher
{
    ...
    public void setSalary(double New_Salary, int New_PerformanceIndex)
    {
        double appraisal = 0.0;//double = can hold double point number like 1.123
        ...
        if(New_PerformanceIndex >= 5 && getworking_hours() > 20)
